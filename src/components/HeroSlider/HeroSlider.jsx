      ...
      >

        {
          item.video
            ...
            ? <div div className='slider-video' style={{ boxShadow: '0 1em 1em -1em rgba(0, 0, 0, .25)' }}
            >
            ...
            : <div className="parallax slider-picture item" style={{ backgroundColor: 'black' }} data-interval="1000">
